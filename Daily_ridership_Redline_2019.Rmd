...
```
```{r}
#to get toatl rides for Red line on for 2019
...
```
```{r}
#seperating dates and daily total rides for 2019 of REDline
library(dplyr)
...
ggplot(filtered_data_Saturday, aes(x = date, y = SumColumn)) +
  ...
  labs(title = "Polynomial Regression-d3 for redline saturdays of 2019",
       x = "date",
       y = "total_daily_rides")
...
print(paste("Average value of Number of riders on Saturday of 2019", average_value))
...
ggplot(filtered_data_Sunday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Sundays of 2019 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Sunday of 2019 :", average_value))
...
ggplot(filtered_data_Monday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Mondays of 2019 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Monday of 2019:", average_value))
```
```{r}
#Tuesday
#Polynomial regression, degree 3
...
ggplot(filtered_data_Tuesday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Tuesdays of 2019 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Tuesday of 2019:", average_value))
```
```{r}
#Wednesday
#Polynomial regression, degree 3
...
ggplot(filtered_data_Wednesday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Wednesday of 2019 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Wednesday of 2019:", average_value))
```
```{r}
##Thursday
#Polynomial regression, degree 3
...
ggplot(filtered_data_Thursday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Thursdays of 2019 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Thursday of 2019:", average_value))
```
```{r}
#Friday
#Polynomial regression, degree 3
...
ggplot(filtered_data_Friday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Fridays of 2019 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Friday of 2019:", average_value))
