...
daily_totals <- read_csv("C:/Drive_d/DPA/Ridership_Analysis/CTA_-_Ridership_-__L__Station_Entries_-_Daily_Totals.csv")

#reading stations in Red Line
redline_stations <- read_csv("C:/Drive_d/DPA/Ridership_Analysis/Redlines.csv")
...
```
```{r}
#to get toatl rides for Red line on for 2021
...
```
```{r}
#seperating dates and daily total rides for 2021 of REDline
library(dplyr)
...
ggplot(filtered_data_Saturday, aes(x = date, y = SumColumn)) +
  ...
  labs(title = "Polynomial Regression-d3 for redline saturdays of 2021",
       x = "date",
       y = "total_daily_rides")
...
print(paste("Average value of Number of riders on Saturday of 2021", average_value))
...
ggplot(filtered_data_Sunday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Sundays of 2021 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Sunday of 2021 :", average_value))
...
ggplot(filtered_data_Monday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Mondays of 2021 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Monday of 2021:", average_value))
```
```{r}
#Tuesday
#Polynomial regression, degree 3
...
ggplot(filtered_data_Tuesday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Tuesdays of 2021 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Tuesday of 2021:", average_value))
```
```{r}
#Wednesday
#Polynomial regression, degree 3
...
ggplot(filtered_data_Wednesday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Wednesday of 2021 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Wednesday of 2021:", average_value))
```
```{r}
##Thursday
#Polynomial regression, degree 3
...
ggplot(filtered_data_Thursday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Thursdays of 2021 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Thursday of 2021:", average_value))
```
```{r}
#Friday
#Polynomial regression, degree 3
...
ggplot(filtered_data_Friday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Fridays of 2021 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Friday of 2021:", average_value))
