...
```
```{r}
#to get toatl rides for Red line on for 2022
...
```
```{r}
#seperating dates and daily total rides for 2022 of REDline
library(dplyr)
...
#Saturday
#linear regression
reg_model <- lm(SumColumn ~ date, data = filtered_data_Saturday)


# Create a scatter plot with regression line
ggplot(filtered_data_Saturday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_smooth(method = "lm", se = FALSE, color = "red") +  # Regression line (method = "lm" for linear regression)
  labs(title = "Linear regression plot for RedLine_saturday_2022",
       x = "date",
       y = "total_daily_rides")


# Calculate the fitted/predicted values from the regression model
predicted_values_lm <- fitted(reg_model)

# Get the actual values of the dependent variable (SumColumn) from filtered_data_Saturday
actual_values_lm <- filtered_data_Saturday$SumColumn

# Calculate the R-squared value
r_squared <- summary(reg_model)$r.squared

# Calculate the Root Mean Squared Error (RMSE)
rmse <- sqrt(mean((actual_values_lm - predicted_values_lm)^2))

# Calculate the Mean Absolute Error (MAE)
mae <- mean(abs(actual_values_lm - predicted_values_lm))
...
poly_degree2 <- 2
poly_reg_model2 <- lm(SumColumn ~ poly(date, poly_degree2), data = filtered_data_Saturday)

# Create a new data frame with predicted values
predicted_data <- data.frame(date = filtered_data_Saturday$date,
                             SumColumn = predict(poly_reg_model2, newdata = filtered_data_Saturday))
...
ggplot(filtered_data_Saturday, aes(x = date, y = SumColumn)) +
  ...
  labs(title = "Polynomial Regression-d3 for redline saturdays of 2022",
       x = "date",
       y = "total_daily_rides")
...
actual_values_p2 <- filtered_data_Saturday$SumColumn

# Get the predicted values of the date variable
predicted_values_p2 <- predict(poly_reg_model2, newdata = filtered_data_Saturday)


# Calculate RMSE
rmse <- sqrt(mean((actual_values_p2 - predicted_values_p2)**2))

# Calculate R-squared
r_squared <- summary(poly_reg_model2)$r.squared
...
print(paste("Average value of Number of riders on Saturday of 2022:", average_value))
summary(predicted_data)
```
```{r}
#Sunday
...
ggplot(filtered_data_Sunday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Sundays of 2022 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Sunday of 2022:", average_value))
summary(predicted_data)
...
ggplot(filtered_data_Monday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Mondays of 2022 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Monday of 2022:", average_value))
...
ggplot(filtered_data_Tuesday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Tuesdays of 2022 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Tuesday of 2022:", average_value))
...
ggplot(filtered_data_Wednesday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Wednesday of 2022 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Wednesday of 2022:", average_value))
...
ggplot(filtered_data_Thursday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Thursdays of 2022 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Thursday of 2022:", average_value))
...
ggplot(filtered_data_Friday, aes(x = date, y = SumColumn)) +
  geom_point() +                     # Scatter plot
  geom_line(data = predicted_data, aes(x = date, y = SumColumn), color = "red") +  # Regression line
  labs(title = "Polynomial Regression-d3 for redline Fridays of 2022 ",
       x = "date",
       y = "total_daily_rides")
...
# Print the average value
print(paste("Average value of Number of riders on Friday of 2022:", average_value))
